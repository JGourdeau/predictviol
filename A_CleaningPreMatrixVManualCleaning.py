...
### Update this at some point to provide a unique file name so we dont overwrite files
res.to_csv("fuzzyMatchRes.csv")

fuzzy_match_violations = res.loc[(res.ld_dt.tz_convert(None) >= res.JOB_START_DATE.tz_convert(None)),:].copy()
